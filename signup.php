...
if(($passwordmatchis_invalid == false) &&
   ($passwordnumberis_invalid == false) &&
   ($passwordlenghtis_invalid == false) &&
   ($passwordcharis_invalid == false) &&
   ($emailis_invalid == false) &&
...
if ($stmt->execute()) {
    ...
    /** code that checks wheater is email unique*/
...
<!DOCTYPE html>
<!--Main sign up page -->
<!--Most of the register system and signup is based on source bellow -->
...
<body style="background-color:#8dc26f ;">
    ...
    <form method="post" id="signup" class="login-form" novalidate>
        <div>
            ...
            <?php if ($firstnameis_invalid): ?>
            <em style="color:red">First name required</em>
            <?php endif; ?>
        </div>
        ...
        <div>
            ...
            <?php if ($lastnameis_invalid): ?>
            <em style="color:red">Last name required</em>
            <?php endif; ?>        
        </div>
        ...
        <div>
            ...
            <?php if ($emailis_invalid): ?>
            <em style="color:red">Uniqe email required</em>
            <?php endif; ?>    
        </div>
        ...
        <div>
            ...
            <input type="password" id="password_confirmation" name="password_confirmation" value="<?= htmlspecialchars($_POST["password_confirmation"] ?? "") ?>">
        </div>
        
        <div>
            <!-- source of phone codes: https://gist.github.com/andyj/7108917 -->
            <!-- needs to be check some values are not match -->
            <label for="countryCode">Phone</label>
            <select name="countryCode" id="countryCode" value="<?= htmlspecialchars($_POST["countryCode"] ?? "") ?>">
                <option data-countryCode="CZ" value="420">Czech Republic (+420)</option>
                <option data-countryCode="SK" value="421">Slovakia (+421)</option>
                <optgroup label="Other countries">
                    <option style="background-image:url(france.png);" data-countryCode="DZ" value="213">Algeria (+213)</option>
    ...
    if (localStorage.getItem('selectedtem')) {
        ...
        <?php if ($allis_invalid): ?>
            <em style="color:red">First required</em>
        <?php endif; ?>
