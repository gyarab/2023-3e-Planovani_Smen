...
<body>
    ...
    <?php if (isset($user)): ?>
        ...
        <div class="container">
          ...
          <br>-->
            ...
            <label id="label1s" style="float:left;font-size: 18px;visibility:hidden;color:red">*Something went wrong. Check if object is selected or
  ...
  success: function (data) {
    $("#shift_ex_load").html(data);
          ...
          <br>-->
            <br>
            <input type="button" id="savebtn" style="font-size: 20px;float:right" class="btn btn-primary" onclick="Save_shift()" value="Save the shift">
            <br>
          
            <br id="hbr1" style="display:none">
            <label id="label1" style="float:left;font-size: 18px;visibility:hidden;color:red">*Something went wrong. Check if object is selected or
              shift has proper name </label>
            <br>
            <br>
