        ...
        <div class="container">
            ...
            <div class="row">
                <div class='col-12 col-md-4'>
                    ...
                    <br>
                    <button id="pause" type="button" style="float: left;bottom:1%;color:#ffffff;display:none" class="btn btn-info">Start break</button>
                    <button id="confirm" type="button" style="float: right;bottom:1%" class="btn btn-warning" onclick="Comfirm()">Confirm arrival</button>
                    <button id="departure" type="button" style="float: right;bottom:1%;display:none" class="btn btn-danger" onclick="Departure()">Confirm departure</button>
                    <?php }?>
                    <br>
                    <br>
                ...
                <div class='col-12 col-md-6'>
                    <div class="p-3 mb-2" style="background:  #4CAF50;color:#ffffff">Current shifts:
                        <div style="float: right">
                            <select class="form-select form-select-sm" name="option" id="option" style="background-color: #4CAF50;color:#ffffff; margin: auto">
                                <?php
