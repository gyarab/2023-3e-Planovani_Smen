...
if ($input != null && $input != "") {
  ...
  if (0 == count($id_arr)) {
    ...
    echo "<select id='se_em' class='form-select' size='7' aria-label='size 3 select example'>";

    for ($i = 0; $i < count($id_arr); $i++) {

      echo "<option onclick='push(this.value)' id='op_em" . $id_arr[$i] . "' value='" . $id_arr[$i] . "' >" . $lastname_arr[$i] . " " . $middlename_arr[$i] . " " . $firstname_arr[$i] . "</option>";
